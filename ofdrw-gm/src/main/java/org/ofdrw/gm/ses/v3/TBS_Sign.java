...
import org.ofdrw.gm.ses.v3.SESeal;
...
public class TBS_Sign extends ASN1Object {
     ...
     * 电子印章
     */
    private org.ofdrw.gm.ses.v3.SESeal eseal;
     ...
     */
    private ASN1OctetString timeInfo;

    /**
     * 原文杂凑值
     */
    private ASN1OctetString dataHash;
    ...
    public TBS_Sign(ASN1Integer version,
                    org.ofdrw.gm.ses.v3.SESeal eseal,
                    ASN1OctetString timeInfo,
...
//        eseal = SESeal.getInstance(((DEROctetString)e.nextElement()).getOctets());
        eseal = org.ofdrw.gm.ses.v3.SESeal.getInstance(e.nextElement());
        timeInfo = DEROctetString.getInstance(e.nextElement());
        dataHash = DEROctetString.getInstance(e.nextElement());
        propertyInfo = DERIA5String.getInstance(e.nextElement());
        cert = DEROctetString.getInstance(e.nextElement());
    ...
    public org.ofdrw.gm.ses.v3.SESeal getEseal() {
        return eseal;
    }
    ...
    public ASN1OctetString getTimeInfo() {
        return timeInfo;
    }

    public TBS_Sign setTimeInfo(ASN1OctetString timeInfo) {
        this.timeInfo = timeInfo;
        return this;
    }

    public ASN1OctetString getDataHash() {
        return dataHash;
    }

    public TBS_Sign setDataHash(ASN1OctetString dataHash) {
        this.dataHash = dataHash;
        return this;
    }
